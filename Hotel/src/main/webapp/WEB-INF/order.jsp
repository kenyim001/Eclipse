...
<script type="text/javascript" src="js/hotel_order.js"></script>
...
<!-- banner -->
	<div class="banner1">
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1><a href="index.html">BZ酒店</a></h1>
				</div>
					<nav class="navbar navbar-default" role="navigation">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="hotelUI.do">后台</a></li>
							</ul>
						</div>
						<!--/.navbar-collapse-->
					</nav>
			...
			<div class="row page-search">
			 <div class="col-md-12">
				<ul class="list-unstyled list-inline">
					<li><input type="text" id="searchNameId" class="form-control"placeholder="客人姓名"></li>
					<li><select id="searchValidId" class="form-control" style="width:80px;">
	...
	<div class="footer">
		<div class="container">
			<div class="col-md-2 deco">
				...
				<li><a href="shortcodes.html">预订</a></li>
